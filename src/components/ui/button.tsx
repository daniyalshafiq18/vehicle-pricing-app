  ...
  'inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 active:scale-[0.95] select-none',
  {
    variants: {
      variant: {
        ...
        gradient: 'brand-gradient relative overflow-hidden text-white shadow-lg shadow-primary/20 hover:shadow-xl hover:shadow-accent/20 animate-gradient-shift hover:scale-[1.02]',
        'gradient-accent': 'relative overflow-hidden bg-gradient-to-r from-accent-700 via-accent to-accent-400 text-accent-foreground shadow-lg hover:shadow-accent/30 hover:from-accent-600 hover:via-accent-400 hover:to-accent bg-[length:200%_100%] animate-gradient-shift hover:scale-[1.02]',
      },
      size: {
        default: 'h-10 px-4 py-2',
        sm: 'h-9 rounded-md px-3 text-sm',
        lg: 'h-12 rounded-lg px-8 text-sm',
        xl: 'h-14 rounded-xl px-10 text-sm',
        icon: 'h-10 w-10',
        'icon-sm': 'h-8 w-8',
      },
    },
